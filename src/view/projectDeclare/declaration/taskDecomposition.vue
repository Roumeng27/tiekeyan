<template>
    ...
    <div class="pageWarpper">
                    ...
                    <div class="changeItem">
                        <div class="resumeWrapper" >
                            ...
                            <div class="resumeSection" v-show="taskFlag">
                                <declareTable :tableData="tableData" :tableHeader="tableHeader" @data="deleteItem"></declareTable>
                            </div>
                        </div>
                        <div class="resumeWrapper">
        ...
        <!-- 新增课题弹框 -->
        <div class="dialogWrapper" v-if="addDialogFlag">
                    ...
                    <div class="editItem">
                        ...
                        <div class="editCenter">
                            ...
                            <div class="treeBox">
                               ...
                               <selectTree @choicedata="companychoice" :number='1' :endlevel="0" :choicedatas="responsableDepartment"></selectTree>
                            </div>
                        </div>
                    </div>
                    <div class="editItem">
                        <div class="editCenter">
                            ...
                            <div class="treeBox">
                                ...
                                <selectTree @choicedata="responsibleAccountchoice" :number='1' :choicelevel="3" :choicedatas="responsiableAdvisor"></selectTree>
                            </div>
                        </div>
                        <div class="editCenter">
                            <div class="editName">总经费 <span>（万元）</span></div>
                            <div class="editContent">
                               <inputs class="inputs" width="220px" v-model="budget" disableds="true" height="30px"></inputs>
                            </div>
                        </div>
                    </div>
                     <div class="editItem" style="padding-bottom:0;">
                        <div class="editCenter">
                            ...
                            <div class="editContent">
                                <inputs class="inputs" width="220px" v-model="funds"  @sumAdd="sumAdd()" height="30px"></inputs>
                            </div>
                        </div>
                        <div class="editCenter">
                            <div class="editName">单位自筹 <span>（万元）</span></div>
                            <div class="editContent">
                               <inputs class="inputs" width="220px" v-model="selfRaised"  @sumAdd="sumAdd()" height="30px"></inputs>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        methods:{
            ...
            sureNewProject(){
                ...
                if(!this.taskName){
                    ...
                    return false;
                }else if(Number(parseInt(this.selfRaised))+Number(this.funds)>parseInt(this.budget) || Number(parseInt(this.selfRaised))+Number(this.funds)<parseInt(this.budget)){
                     this.$message({
                        message: "请输入正确的值!",
                        type: "info"
                    });
