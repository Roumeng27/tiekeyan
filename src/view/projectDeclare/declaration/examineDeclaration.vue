          ...
          <div class="editItem">
            <div class="editCenter">
              ...
              <div class="editContent">
                <inputs class="inputs" width="280px" v-model="name" height="30px" disableds="true"></inputs>
              </div>
            </div>
            <div class="editCenter">
              <div class="editName">项目类别</div>
              <div class="editContent">
                <inputs class="inputs" width="280px" v-model="type" height="30px" disableds="true"></inputs>
              </div>
            </div>
          </div>
          <div class="editItem">
            <div class="editCenter">
              ...
              <div class="editContent">
                <inputs class="inputs" width="280px" v-model="subject" height="30px" disableds="true"></inputs>
              </div>
            </div>
            <div class="editCenter">
              <div class="editName">研究方向</div>
              <div class="editContent">
                <inputs class="inputs" width="280px" v-model="direction" height="30px" disableds="true"></inputs>
              </div>
            </div>
          </div>
          <div class="editItem">
            <div class="editCenter">
              ...
              <div class="editContent">
                <inputs class="inputs" width="120px" v-model="startDate" height="30px" disableds="true"></inputs>
                <span>—</span>
                <inputs class="inputs" width="120px" v-model="endDate" height="30px" disableds="true"></inputs>
              </div>
            </div>
            <div class="editCenter">
              <div class="editName">实施周期</div>
              <div class="editContent">
                <inputs class="inputs" width="280px" v-model="monthNum" height="30px" disableds="true"></inputs>
              </div>
            </div>
          </div>
          <div class="editItem">
            ...
            <div class="editCenter">
              <div class="editArea">
                ...
                <div class="editContent">
                  <inputs class="inputs" width="90px" v-model="funds" height="30px" disableds="true"></inputs>
                </div>
              </div>
              <div class="editArea">
                <div class="editName">
                ...
                <div class="editContent">
                  <inputs class="inputs" width="90px" v-model="selfRaised" height="30px" disableds="true"></inputs>
                </div>
              </div>
            </div>
          </div>
...
<script>
import {personnelSelectlist , declareAddDeclare ,declareeSlectInformationById,declareeUpdateById} from "http/formalDeclaration";
