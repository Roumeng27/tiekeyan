<template>
    ...
    <div class="pageWarpper">
                    ...
                    <div class="changeItem">
                        ...
                        <div class="changeWrapper" v-show="changeFlag">
                            <div class="changeMain" >
                                <div class="editItem">
                                    <div class="editCenter">
                                        ...
                                        <div class="editContent">
                                            <inputs class="inputs" disableds="true" width="280px" v-model="name" height="30px"></inputs>
                                        </div>
                                    </div>
                                    <div class="editCenter">
                                        <div class="editArea">
                                            ...
                                            <div class="editContent">
                                                <inputs class="inputs" disableds="true" width="74px" v-model="gender" height="30px"></inputs>
                                            </div>
                                        </div>
                                        <div class="editArea" style="padding-left:5px;">
                                            <div class="editName">出生日期</div>
                                            <div class="editContent">
                                                <inputs class="inputs" disableds="true" width="128px" v-model="birthday" height="30px"></inputs>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="editItem">
                                    <div class="editCenter">
                                        ...
                                        <div class="editContent">
                                            <inputs class="inputs" disableds="true" width="280px" v-model="idType" height="30px"></inputs>
                                        </div>
                                    </div>
                                    <div class="editCenter">
                                        <div class="editName">证件号码</div>
                                        <div class="editContent">
                                        <inputs class="inputs" disableds="true" width="280px" v-model="idNo" height="30px"></inputs>
                                        </div>
                                    </div>
                                </div>
                                <div class="editItem">
                                    <div class="editCenter">
                                        ...
                                        <div class="editContent">
                                            <inputs class="inputs" disableds="true" width="280px" v-model="degree" height="30px"></inputs>
                                        </div>
                                    </div>
                                    <div class="editCenter">
                                        <div class="editName">所在单位</div>
                                        <div class="editContent">
                                        <inputs class="inputs" disableds="true" width="280px" v-model="companyName" height="30px"></inputs>
                                        </div>
                                    </div>
                                </div>
                                <div class="editItem">
                                    <div class="editCenter">
                                        ...
                                        <div class="editContent">
                                            <inputs class="inputs" disableds="true" width="280px" v-model="title" height="30px"></inputs>
                                        </div>
                                    </div>
                                    <div class="editCenter">
                                        <div class="editName">职务</div>
                                        <div class="editContent">
                                        <inputs class="inputs" disableds="true" width="280px" v-model="job" height="30px"></inputs>
                                        </div>
                                    </div>
                                </div>
                                <div class="editItem">
                                    <div class="editCenter">
                                        ...
                                        <div class="editContent">
                                            <inputs class="inputs" disableds="true" width="280px" v-model="phone" height="30px"></inputs>
                                        </div>
                                    </div>
                                    <div class="editCenter">
                                        <div class="editName">电子邮箱</div>
                                        <div class="editContent">
                                        <inputs class="inputs" disableds="true" width="280px" v-model="email" height="30px"></inputs>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="resumeBox">
                                ...
                                <div class="resumeMain">
                                    <el-input type="textarea" disabled="disabled" v-model="resume" maxlength="1000"></el-input>
                                </div>
                            </div>
                            <div class="resumeBox" >
                                <div class="resumeTitle">
                                ...
                                <div class="resumeSection">
                                    <declareTable :tableData="declareExperienceList" :disabled="true" :tableHeader="declareExperienceHeader" @data="deleteItem"></declareTable>
                                </div>
                            </div>
                        </div>
                        <div class="resumeWrapper" style="margin:10px 0">
                            ...
                            <div class="resumeSection" v-show="memberInfoFlag">
                                <participateTable :disabled="true"  :disableFlag='true' :tableData="projectMemberData"  :tableHeader="projectMemberHeader" @data="deleteItem"></participateTable>
                            </div>
                        </div>
        ...
        <!-- 新增项目负责人历史参与项目弹框 -->
        <div class="dialogWrapper" v-show="historyDialogFlag">
...
<script>
    ...
    export default {
        ...
        methods:{
            // 初始化查询
            getInitInfo(){
                declarePersonSelect(this.declareId).
                then(res => {
                    if (res.result == "SUCCESS") {
                        ...
                        this.seniorTitleNum	= res.data.declareVo.seniorTitleNum;// 正高级职称人数
            ...
            addDeclarePersonInfo(){
                ...
                arr.push(obj)
                this.declareExperienceList = arr;
                this.historyDialogFlag = false;
            ...
            addSure(){
                ...
                list.map((item,index)=>{
                    array.push(
                        Object.assign({},item,{project:this.project})
                    )
                });
                this.projectMemberData = array;
                this.dialogFlag = false;
                // input框清空
                this.project = '';
